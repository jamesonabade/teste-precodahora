...
-- 1. Garantir que os dados mínimos estejam na nova base antes de apagar (se ainda existirem)
DO $$
BEGIN
    IF to_regclass('public.estabelecimentos') IS NOT NULL THEN
    ...
    IF to_regclass('public.produtos_catalogo') IS NOT NULL THEN
